<template>
    <section class="text-center text-lg-start">
        <div class="container py-4">
            <div class="row g-0 align-items-center">
                ...
                <div class="flex justify-between items-center p1em">
                    <b-button @click="backtoWelcome()">back to welcome page</b-button>
                            ...
                            <table class="table table-hover">
                                ...
                                <tbody>
                                    <tr v-for="(val, index) in recordListdata" :key="val.id">
                                        ...
                                        <th>{{ val.phone }}</th>
                                        <th>
                                            <button type="button" class="btn btn-primary" @click="viewEditList(val.id)"><svg
                                            ...
                                            <button type="button" class="btn btn-danger"
                                                @click="removeList(val.id, index)"><svg xmlns="http://www.w3.org/2000/svg"
        ...
        <!-- edit modal -->
        <template>
            <b-modal id="modal-1" v-model="editModal" title="Edit Records" no-close-on-esc no-close-on-backdrop centered
                hide-footer>
