<template>
  <div class="min-h-screen overflow-auto p-2 flex justify-center items-center bg-blue-300">
    <div class="w-max mx-4 lg:w-1/3">
      <form class="bg-white shadow-md rounded-md px-8 pt-6 pb-8 mb-4 box-border" @submit="register">
        ...
        <div class="flex flex-wrap -mx-3 mb-6">
          ...
          <div class="w-full md:w-1/2 px-3">
            ...
            <input v-model="user.password_confirmation" class="shadow appearance-none borderrounded w-full py-2 px-3 text-gray-700 mb-3 leading-tight focus:outline-none focus:shadow-outline" id="confirm_password" type="password" placeholder="******************">
          </div>
        </div>
