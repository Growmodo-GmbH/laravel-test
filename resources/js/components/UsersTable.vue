    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-12" style="padding-top: 35px;">
                <button @click="$router.push('/home')" type="button" class="btn btn-success" style="float: left;">Back to Dashboard</button>
              ...
              <div class="table-responsive">
                ...
                <tbody>
                    <tr v-for="user in result.users" v-bind:key="user.id">
                        ...
                        <td>
                          <button @click.prevent="handleEdit(user.id)" type="button" class="btn btn-warning">Edit</button>
