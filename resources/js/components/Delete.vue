            ...
            <div class="relative transform overflow-hidden rounded-lg bg-white text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg">
                <form class="px-8 pt-6 pb-8 mb-4">
                    ...
                    <div class="flex items-center justify-center w-full mb-2">
                        <h1 class="text-2xl font-bold text-blue-800">Delete a User</h1>
                    </div>
                    <div class="my-4">
                      <p class="text-md text-blue-800 text-center">Are you sure you want to delete <b>{{ deletedUser.username }}</b>? All of <b>{{ deletedUser.username }}'s</b> data will be permanently removed. This action cannot be undone.</p>
                    </div>
                    <div class="flex items-center justify-center w-full">
                      ...
                      <button @click="deleted(deletedUser.id)" class="mx-2 bg-blue-800 hover:bg-blue-900 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline" type="button">
                        Confirm
                      </button>
                    </div>
                </form>
